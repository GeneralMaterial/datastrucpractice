package testers.queue;

import structures.queues.BasicQueue;
...
public class SnowbirdLiftApp {
  ...
  public void runLift() {
    ...
    System.out.println(
        "Lift has Mary and Anna on it: " + gad2Lift.contains(new Gad2Chair("Mary", "Anna")));
  ...
  class Gad2Chair {
    ...
    public boolean equals(Object obj) {
      ...
      if (seat1Name == null) {
        if (other.seat1Name != null) return false;
      } else if (!seat1Name.equals(other.seat1Name)) return false;
      if (seat2Name == null) {
        if (other.seat2Name != null) return false;
      } else if (!seat2Name.equals(other.seat2Name)) return false;
      return true;
    }
